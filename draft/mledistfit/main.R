# This code load a vector of patch size, fits several functions (MLE fitting) to the patch size distribution, compares the fits and plots the data + fitted functions.
...
# In that case use this command in place of the above on 
...
com = compare_distributions(pow,lnorm) # Compare all required combinations
...
# For bootstrapping to check the fit of the best fit distribution, see the documentation for 
# the R 'poweRlaw package
