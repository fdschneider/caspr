...
#' @param filename A character value specifying relative path and filename.  
#' @param type (intended) A character value specifying the type of output. Either "gif" or "mpg". 
#' @param speed A numeric value specifying the speed of the output (defaults to 1). 
#'
#' @return Returns an animated gif file. 
#' 
...
animate <- function(x, filename, type = "gif", speed = 1) {
